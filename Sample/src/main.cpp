...
int main(int argc, char** argv)
{
	...
	manager.AddScene(std::make_unique<MenuPlay>(KGR::Tools::Chrono<float>::Time::CreateFromValue(1.0f / 60.0f)), "Menu", true);
	manager.AddScene(std::make_unique<MenuGO>(KGR::Tools::Chrono<float>::Time::CreateFromValue(1.0f / 60.0f)), "MenuGO", false);
